...
fun main() {
    var persons = listOf(
        Student("Бекманбетов Олег", 2000, 4.3),
        Student("Фишингов Антон", 2001, 4.1),
        Student("Растрворова Екатерина",2000, 3.9, true),
        Student("Агрогномов Даниил", 2001, 4.6),
        Student("Моисеев Игорь", 2002, 5.0, true),
        Lecturer("Никифоров Пётр", 1972, "Кандидат технических наук", 2001),
        ...
        Lecturer("Кабанов Александр", 1954, "Доктор технических наук", 1992),
        Lecturer("Зенитова Татьяна", 1963, "Доктор филологических наук", 2001)
    )
